...
if (isset($_REQUEST['upload']))
{
    ...
    if ((($type == "video/mp4") || ($type == "video/3gpp")  || ($type == "video/x-flv")) && ($size < 200000000 ))
    {
...
?>
        <fieldset>
            <legend>Upload Video Dengan PHP (<a href="http://www.tutorial-webdesign.com/cara-upload-video-dengan-php">
                    baca tutorial </a>)</legend>

...
<head>
    ...
    <title>Info Kunjungan | DataTables</title>
                                ...
                                <div class="card-body">
                                    <table id="example1" class="table table-bordered table-striped">
                                        ...
                                        <tbody>
                                            <?php 
                                            $no=1;
                                            $ambilsemuadatakunjungan = mysqli_query($conn,"select * from kunjungan");
                                            while($data =mysqli_fetch_array($ambilsemuadatakunjungan)){
                                                $idk = $data['idkunjungan'];
                                                $kantor = $data['kantor'];
                                        ...
                                        ?>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <button type="button" class="btn btn-primary" data-toggle="modal"
                                                        data-target="#edit<?=$idk;?>"><i class="fa fa-edit"></i>
                                                        Edit
                                                    </button>

                                                    <button type="button" class="btn btn-danger" data-toggle="modal"
                                                        data-target="#delete<?=$idk;?>"><i class="fa fa-trash"></i>
                                                        Delete
                                                    </button>
                                                </td>
                                            </tr>
                                                    ...
                                                    <div class="modal-content">
                                                        ...
                                                        <form method="post">
                                                            <div class="modal-body">
                                                                <input type="text" name="kantor" value="<?=$kantor;?>"
                                                                    class="form-control">
                                                                <br>
                                                                ...
                                                                <br>
                                                                <br>
                                                                <input type="hidden" name="idkunjungan"
                                                                    value="<?=$idk;?>">
                                                                <button type="submit" class="btn btn-primary"
                                                                    name="updatekunjungan">Submit</button>
                                                        </form>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <form method="post">
                                                <div class="modal-body">
                                                    ...
                                                    <br>
                                                    <br>
                                                    <input type="hidden" name="idkunjungan" value="<?=$idk;?>">
                                                    <button type="submit" class="btn btn-primary"
                                                        name="deletekunjungan">Submit</button>
                                            </form>
                                        </div>
                                    </div>
                                </div>
...
<div class="modal fade" id="addtamu">
    <div class="modal-dialog">
        <div class="modal-content bg-primary">
            <div class="modal-header">
                <h4 class="modal-title">Insert Data Kunjungan</h4>
